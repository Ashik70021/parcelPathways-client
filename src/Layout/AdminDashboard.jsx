...
const AdminDashboard = () => {
    ...
    return (
        <div className="flex">
            {/* Dashboard sideBar */}
            <div className="bg-[#ffe29a] min-h-screen p-3 space-y-2 w-60 dark:bg-gray-50 dark:text-gray-800">
                ...
                <div className="divide-y dark:divide-gray-300">
                    <ul className="menu pt-2 pb-4 space-y-1 text-sm">
                        ...
                        <li className="dark:bg-gray-100 dark:text-gray-900">
                            <Link to="/admindashboard/parcels" className="">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current dark:text-gray-600">
                        ...
                        <li className="dark:bg-gray-100 dark:text-gray-900">
                            <Link to="/admindashboard/users" className="">
                        ...
                        <li className="dark:bg-gray-100 dark:text-gray-900">
                            <Link to="/admindashboard/deliveryman">
                    ...
                    <ul className="pt-4 pb-2 space-y-1 text-sm">
                        ...
                        <li>
                            <a rel="noopener noreferrer" href="/admindashboard/myprofile" className="flex items-center p-2 space-x-3 rounded-md">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current dark:text-gray-600">
